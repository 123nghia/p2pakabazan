...
public interface DisputeRepository extends JpaRepository<Dispute, Long> {
    ...
    List<Dispute> findByStatusAndAssignedAdminOrderByCreatedAtDesc(DisputeStatus status, User assignedAdmin);

    List<Dispute> findByAssignedAdminOrderByCreatedAtDesc(User assignedAdmin);
